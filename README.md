...
<html>
	<head>
		<title>CV | Sinung Adi Nugroho</title>
		<meta charset="utf-8" />
					...
					<header id="header">
						...
						<div class="content">
							<div class="inner">
								...
								<p>Welcome to my personal page. Explore my page and enjoy it.</p>
							</div>
						</div>
						<nav>
							<ul>
					...
					<div id="main">
						...
						<!-- Intro -->
							<article id="intro">
								...
								<p>Hello, Perkenalkan saya Sinung Adi Nugroho atau biasa dipanggil Sinung. Sekarang saya sedang berkuliah di Universitas Padjadjaran jurusan Bisis Digital. Saya lahir pada tanggal 11 Maret 2001 di Klaten. Jika anda ingin tahu saya lebih dalam, jelajahi personal web saya ini.</p>
